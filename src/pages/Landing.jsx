...
export default function Landing() {
  ...
  // Auto-redirect to the Telegram channel shortly after the page loads
  useEffect(() => {
    const timer = setTimeout(() => {
      window.location.replace(CHANNEL_URL);
    }, 1000);
  ...
  return (
    <div
      ...
      style={{
        background: 'radial-gradient(circle at 50% 50%, #0a1018 0%, #05070A 60%, #020306 100%)',
        cursor: 'none',
      }}
    >
      {!reduceMotion && (
